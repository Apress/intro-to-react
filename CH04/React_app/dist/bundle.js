...
var App = React.createClass({
	...
	render: function render() {
		return React.createElement(
			"div",
			null,
			this.state.signedIn ? React.createElement(WorkoutLog, { onLogout: this._onLogout }) : React.createElement(Authentication, { onAuthComplete: this._onAuthComplete })
		);
	},

	_onAuthComplete: function _onAuthComplete(result) {
...
},{"./auth.jsx":158,"./workoutlog.jsx":165,"react":156}],158:[function(require,module,exports){
"use strict";
...
var Authentication = React.createClass({
	...
	render: function render() {
		return React.createElement(
			"div",
			null,
			React.createElement(SignIn, { onAuthComplete: this.props.onAuthComplete }),
			React.createElement(CreateAccount, { onAuthComplete: this.props.onAuthComplete })
		);
	}
});
...
},{"./createaccount.jsx":159,"./signin.jsx":163,"react":156}],159:[function(require,module,exports){
"use strict";
	...
	render: function render() {
		return React.createElement(
			...
			React.createElement(
				...
				{ htmlFor: "password" },
				"Confirm Password:",
				React.createElement("input", { type: "text", id: "confpassword" })
			),
			React.createElement(
				"button",
	...
	render: function render() {
		return React.createElement(
			...
			React.createElement(
				...
				{ htmlFor: "defineName" },
				"Define Name",
				React.createElement("input", { type: "text", id: "defineName" })
			),
			React.createElement(
				"label",
				{ htmlFor: "defineType" },
				"Define Type",
				React.createElement("input", { id: "defineType", type: "text" })
			),
			React.createElement(
				"label",
				{ htmlFor: "defineDesc" },
			...
			React.createElement("textarea", { id: "defineDesc" }),
			React.createElement(
				"button",
				{ id: "saveDefinition" },
				"Save Definition"
...
var History = React.createClass({
	...
	render: function render() {
		...
		for (var i = 0; i < hist.length; i++) {
			...
			formatedLi.push(React.createElement(ListItem, histObj));
		}
		return React.createElement(
			"div",
			null,
...
var StoreWorkout = React.createClass({
	...
	render: function render() {
		...
		for (var i = 0; i < this._mockWorkouts.length; i++) {
			opts.push(React.createElement(Option, { value: this._mockWorkouts[i].name }));
		}
		return React.createElement(
			"div",
			...
			React.createElement("input", { id: "workoutResult", type: "text" }),
			React.createElement("input", { id: "workoutDate", type: "date" }),
			React.createElement(
				"label",
				{ htmlFor: "notes" },
				"Notes:"
...
var WorkoutLog = React.createClass({
	...
	render: function render() {
		return React.createElement(
			...
			React.createElement(Nav, { onLogout: this.props.onLogout, onNav: this._onNav }),
			this.state.view === "define" ? React.createElement(DefineWorkout, null) : "",
			this.state.view === "store" ? React.createElement(StoreWorkout, null) : "",
			this.state.view === "history" ? React.createElement(History, null) : ""
		);
	},

	_onNav: function _onNav(theView) {
...
},{"./define.jsx":160,"./history.jsx":161,"./navigation.jsx":162,"./store.jsx":164,"react":156}]},{},[157]);
